...
class ShipmentsAndLabelsApi
{
     ...
     *
     * @param  \Dhl\Rest\Shipping\Model\ShipmentOrderRequest $shipment_order_request shipment_order_request (required)
     ...
     * @return \Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus
     */
     ...
     * Create one or more shipments and their documents. (This is the primary call of the API.)
     *
     * @param  \Dhl\Rest\Shipping\Model\ShipmentOrderRequest $shipment_order_request (required)
     * @param  string|null $accept_language Control the APIs response language via locale abbreviation. English (en-US) and german (de-DE) are supported. If not specified, the default is english. (optional)
     * @param  bool|null $validate If provided and set to &#x60;true&#x60;, the input document will be:   * validated against JSON schema (/orders/ endpoint) at the API layer. In case of errors, HTTP 400 and details will be returned.   * validated against the DHL backend.   In that case, no state changes are happening, no data is stored, shipments neither deleted nor created, no labels being returned. The call will return a status (200, 400) for each shipment element. (optional, default to false)
     * @param  bool|null $must_encode Legacy name **printOnlyIfCodable**. If set to *true*, labels will only be created if an address is encodable. This is only relevant for German consignee addresses. If set to false or left out, addresses, that are not encodable will be printed even though you receive a warning. (optional, default to false)
     * @param  string|null $include_docs Legacy name **labelResponseType**. Shipping labels and further shipment documents can be:  * __include__: included as base64 encoded data in the response (default)  * __URL__: provided as URL reference. (optional, default to 'include')
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus
     */
