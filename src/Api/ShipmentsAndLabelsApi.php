...
class ShipmentsAndLabelsApi
{
     ...
     *
     * @param  \Dhl\Rest\Shipping\Model\ShipmentOrderRequest $shipment_order_request Shipment order request. (required)
     ...
     * @param  bool|null $print_dhl_logo Defines whether the DHL Logo should be included on the shipping label. **Does not affect return labels**.If not provided, default from user profile will be used. (optional)
     * @param  bool|null $print_dhl_logo_retoure Defines whether the DHL Logo should be included on the generated **return/retoure** label. Does not affect non-return labels.If not provided, default from user profile will be used. (optional)
     ...
     * @return \Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\RequestStatus
     */
    public function createOrders(
        \Dhl\Rest\Shipping\Model\ShipmentOrderRequest $shipment_order_request,
        ...
        ?bool $combine = true,
        ?bool $print_dhl_logo = null,
        ?bool $print_dhl_logo_retoure = null,
        ...
        list($response) = $this->createOrdersWithHttpInfo($shipment_order_request, $accept_language, $validate, $must_encode, $include_docs, $doc_format, $print_format, $retoure_print_format, $combine, $print_dhl_logo, $print_dhl_logo_retoure, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOrdersWithHttpInfo(
        ...
        $request = $this->createOrdersRequest($shipment_order_request, $accept_language, $validate, $must_encode, $include_docs, $doc_format, $print_format, $retoure_print_format, $combine, $print_dhl_logo, $print_dhl_logo_retoure, $contentType);
    ...
    public function createOrdersAsync(
        ...
        return $this->createOrdersAsyncWithHttpInfo($shipment_order_request, $accept_language, $validate, $must_encode, $include_docs, $doc_format, $print_format, $retoure_print_format, $combine, $print_dhl_logo, $print_dhl_logo_retoure, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function createOrdersRequest(
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $print_dhl_logo_retoure,
            'printDhlLogoRetoure', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SplFileObject|\Dhl\Rest\Shipping\Model\RequestStatus
     */
    public function getLabel(
        string $token,
        string $contentType = self::contentTypes['getLabel'][0]
    ): \SplFileObject|\Dhl\Rest\Shipping\Model\RequestStatus {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SplFileObject|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  bool|null $combine If set, label and return label for one shipment will be printed as single PDF document with possibly multiple pages. Else, those two labels come as separate documents. The option does not affect customs documents and COD labels. (optional, default to true)
     * @param  bool|null $print_dhl_logo Defines whether the DHL Logo should be included on the generated label. **Does not affect return labels**.If not provided, default from user profile will be used. (optional)
     * @param  bool|null $print_dhl_logo_retoure Defines whether the DHL Logo should be included on the generated **return/retoure** label. Does not affect non-return labels. If not provided, default from user profile will be used. (optional)
    ...
    public function getOrder(
        ...
        list($response) = $this->getOrderWithHttpInfo($shipment, $accept_language, $doc_format, $print_format, $retoure_print_format, $include_docs, $combine, $print_dhl_logo, $print_dhl_logo_retoure, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\LabelDataResponse|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus|\Dhl\Rest\Shipping\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderWithHttpInfo(
        ...
        $request = $this->getOrderRequest($shipment, $accept_language, $doc_format, $print_format, $retoure_print_format, $include_docs, $combine, $print_dhl_logo, $print_dhl_logo_retoure, $contentType);
    ...
    public function getOrderAsync(
        ...
        return $this->getOrderAsyncWithHttpInfo($shipment, $accept_language, $doc_format, $print_format, $retoure_print_format, $include_docs, $combine, $print_dhl_logo, $print_dhl_logo_retoure, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
