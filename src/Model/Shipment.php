...
class Shipment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'product' => '\Dhl\Rest\Shipping\Model\Product',
    ...
    */
     ...
     * Gets product
     *
     * @return \Dhl\Rest\Shipping\Model\Product|null
     */
    public function getProduct(): ?\Dhl\Rest\Shipping\Model\Product
    {
     ...
     * Sets product
     *
     * @param \Dhl\Rest\Shipping\Model\Product|null $product product
     *
     * @return $this
     */
    public function setProduct(?\Dhl\Rest\Shipping\Model\Product $product): static
    {
        if (is_null($product)) {
