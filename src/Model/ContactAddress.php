...
class ContactAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets address_street
     *
     * @param string|null $address_street Line 1 of the street address. This is just the street name. Can also include house number. If the house number is included Street and house number must be separated by a space to avoid validation errors.
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Mandatory for all countries that use a postal code system.
     *
     * @return $this
     */
